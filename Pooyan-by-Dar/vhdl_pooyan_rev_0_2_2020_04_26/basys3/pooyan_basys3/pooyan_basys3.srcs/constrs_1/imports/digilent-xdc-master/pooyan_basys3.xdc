# pooyan_basys3.xdc - generated by contrib/basys3/create_project.sh
# from the Digilent Basys-3-Master.xdc template (contrib/basys3/,
# https://github.com/Digilent/digilent-xdc/blob/master/Basys-3-Master.xdc).
# Uncommented lines are the pins used by the IO mapping in
# Pooyan-by-Dar/README.md (source of truth); unused pins stay commented.
#

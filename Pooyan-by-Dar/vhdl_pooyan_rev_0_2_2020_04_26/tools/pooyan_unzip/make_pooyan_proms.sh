#!/bin/bash
# Port of the shipped make_pooyan_proms.bat (mechanical translation,
# see top-level README "Stage the ROMs and generate the PROM VHDL").
# Created by contrib/basys3/create_project.sh when missing.
set -e
...
rm -f pooyan_prog.bin
rm -f pooyan_sound.bin

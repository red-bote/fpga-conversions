#!/bin/bash
# Drive Vivado to synthesise and build the Pooyan Basys3 bitstream.
#
...
XPR="$ROOT/vhdl_pooyan_rev_0_2_2020_04_26/basys3/pooyan_basys3/pooyan_basys3.xpr"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_pooyan_rev_0_2_2020_04_26/basys3/pooyan_basys3/pooyan_basys3.runs/impl_1/pooyan_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else

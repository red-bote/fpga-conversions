...
# (rtl_dar/burger_time_de10_lite.vhd) into the Basys3 top level
# (burger_time_basys3.vhd).
#
# The target burger_time_basys3.vhd is authored here (it is a full rewrite of
...
#      patch at contrib/basys3/code/burger_time_de10_lite_to_basys3.patch
#      (matching the Pooyan/Time-Pilot/Bagman/Berzerk/Burnin-Rubber convention;
#      the fix patches stay flat in contrib/code/).
#   3. Places the target where burger_time_basys3.xpr expects it
#      (basys3/burger_time_basys3.srcs/sources_1/new/burger_time_basys3.vhd).
#
...
SRC="$ROOT/vhdl_burger_time_rev_0_0_2017_12_27/rtl_dar/burger_time_de10_lite.vhd"
PROJ_DIR="$ROOT/vhdl_burger_time_rev_0_0_2017_12_27/basys3"
TARGET_SRC="$PROJ_DIR/burger_time_basys3.srcs/sources_1/new"
PATCH="$ROOT/contrib/basys3/code/burger_time_de10_lite_to_basys3.patch"

WORK=/tmp/burger_time_de10_to_basys3
TARGET="$WORK/burger_time_basys3.vhd"

if [ ! -f "$SRC" ]; then
    echo "error: pristine source not found: $SRC" >&2
    echo "Run 'make setup' first to populate vhdl_burger_time_rev_0_0_2017_12_27/." >&2
    exit 1
fi
...
{
  printf 'diff --git a/vhdl_burger_time_rev_0_0_2017_12_27/rtl_dar/burger_time_de10_lite.vhd b/vhdl_burger_time_rev_0_0_2017_12_27/rtl_dar/burger_time_de10_lite.vhd\n'
  diff -u --label "a/vhdl_burger_time_rev_0_0_2017_12_27/rtl_dar/burger_time_de10_lite.vhd" \
            --label "b/vhdl_burger_time_rev_0_0_2017_12_27/rtl_dar/burger_time_de10_lite.vhd" \
            "$SRC" "$TARGET" || [ $? -eq 1 ]   # diff returns 1 when files differ (expected)
} > "$PATCH"

mkdir -p "$TARGET_SRC"
cp -f "$TARGET" "$TARGET_SRC/burger_time_basys3.vhd"

rm -rf "$WORK"

echo "Generated patch:  $PATCH"
echo "Placed target:    $TARGET_SRC/burger_time_basys3.vhd"
echo "Verify with:      patch -p1 --dry-run < contrib/basys3/code/burger_time_de10_lite_to_basys3.patch"

#!/bin/bash
# Drive Vivado to synthesise and build the BurgerTime Basys3 bitstream.
#
...
#   vhdl_burger_time_rev_0_0_2017_12_27/basys3/burger_time_basys3.runs/impl_1/burger_time_basys3.bit
#
...
XPR="$ROOT/vhdl_burger_time_rev_0_0_2017_12_27/basys3/burger_time_basys3.xpr"
...
WORK=/tmp/burger_time_bitstream
mkdir -p "$WORK"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_burger_time_rev_0_0_2017_12_27/basys3/burger_time_basys3.runs/impl_1/burger_time_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else

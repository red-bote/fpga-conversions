#!/bin/bash
# Drive Vivado to synthesise and build the Berzerk Basys3 bitstream.
#
...
#   vhdl_berzerk_rev_0_1_2018_08_08/basys3/berzerk_basys3.runs/impl_1/berzerk_basys3.bit
#
...
XPR="$ROOT/vhdl_berzerk_rev_0_1_2018_08_08/basys3/berzerk_basys3.xpr"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_berzerk_rev_0_1_2018_08_08/basys3/berzerk_basys3.runs/impl_1/berzerk_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else

#!/bin/bash
# Generate the clk_wiz_0 MMCM IP (100 MHz -> 10 MHz core) for the
# Basys3 port and place its Verilog wrappers where berzerk_basys3.xpr expects them.
#
# The main project's .xpr references two imported files (berzerk_basys3.xpr):
#   sources_1/imports/clk_wiz_0/clk_wiz_0.v
#   sources_1/imports/clk_wiz_0/clk_wiz_0_clk_wiz.v
# The IP is generated here in a throwaway Vivado project named mmcm_10m and
...
XPR_DIR="$(cd "$(dirname "$0")/../../../vhdl_berzerk_rev_0_1_2018_08_08/basys3" && pwd)"
CLK_WIZ_IMPORT_DIR="$XPR_DIR/berzerk_basys3.srcs/sources_1/imports/clk_wiz_0"
...
cat > "$TCL" <<EOF
create_project mmcm_10m "$WORK" -part $PART -force

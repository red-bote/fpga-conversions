#!/bin/bash
# Drive Vivado to synthesise and build the Defender Basys3 bitstream.
#
...
#   vhdl_defender_rev_0_0_2017_10_15/basys3/defender_basys3.runs/impl_1/defender_basys3.bit
#
...
XPR="$ROOT/vhdl_defender_rev_0_0_2017_10_15/basys3/defender_basys3.xpr"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_defender_rev_0_0_2017_10_15/basys3/defender_basys3.runs/impl_1/defender_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else

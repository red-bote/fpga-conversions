#!/bin/bash
# Drive Vivado to synthesise and build the Galaga Basys3 bitstream.
#
...
#   vhdl_galaga_rev_0_3_2018_05_06/basys3/galaga_basys3.runs/impl_1/galaga_basys3.bit
#
...
XPR="$ROOT/vhdl_galaga_rev_0_3_2018_05_06/basys3/galaga_basys3.xpr"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_galaga_rev_0_3_2018_05_06/basys3/galaga_basys3.runs/impl_1/galaga_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else

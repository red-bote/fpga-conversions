...
# the Basys3 port and place its Verilog wrappers where solar_fox_basys3.xpr
# expects them.
#
# The main project's .xpr references two imported files (solar_fox_basys3.xpr):
...
XPR_DIR="$(cd "$(dirname "$0")/../../../vhdl_solar_fox_rev_0_1_2019_11_22/basys3" && pwd)"
CLK_WIZ_IMPORT_DIR="$XPR_DIR/solar_fox_basys3.srcs/sources_1/imports/clk_wiz_0"

#!/bin/bash
# Drive Vivado to synthesise and build the Bagman Basys3 bitstream.
#
...
#   vhdl_bagman_rev_0_1_2018_06_05/basys3/bagman_basys3.runs/impl_1/bagman_basys3.bit
#
...
XPR="$ROOT/vhdl_bagman_rev_0_1_2018_06_05/basys3/bagman_basys3.xpr"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_bagman_rev_0_1_2018_06_05/basys3/bagman_basys3.runs/impl_1/bagman_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else

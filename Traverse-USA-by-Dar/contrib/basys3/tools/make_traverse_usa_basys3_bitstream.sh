#!/bin/bash
# Drive Vivado to synthesise and build the Traverse USA Basys3 bitstream.
#
...
#   vhdl_traverse_usa_rev_0_0_2019_03_16/basys3/traverse_usa_basys3.runs/impl_1/traverse_usa_basys3.bit
#
...
XPR="$ROOT/vhdl_traverse_usa_rev_0_0_2019_03_16/basys3/traverse_usa_basys3.xpr"
...
WORK=/tmp/traverse_usa_bitstream
mkdir -p "$WORK"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_traverse_usa_rev_0_0_2019_03_16/basys3/traverse_usa_basys3.runs/impl_1/traverse_usa_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else

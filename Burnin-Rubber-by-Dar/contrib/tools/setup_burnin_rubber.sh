#!/bin/bash
# Download, extract, and patch the Burnin' Rubber Dar source archive, then chain
# into the rom-prep script.
#
# 1. Fetch vhdl_burnin_rubber_rev_0_0_2017_12_22.zip from SourceForge into the cache
...
# 2. Extract it into the repo root as vhdl_burnin_rubber_rev_0_0_2017_12_22/.
...
EXPECTED_SHA256="fed43686919a56ae1b8b595af174d9dc4cd3807aa5d8c7698a62d54b151727dc"

DLOAD_DIR="$ROOT/dloads"
ZIP="$DLOAD_DIR/vhdl_burnin_rubber_rev_0_0_2017_12_22.zip"
...
step "2/4 Extracting vhdl_burnin_rubber_rev_0_0_2017_12_22/ into repo root"
mkdir -p "$SRC_DIR"
unzip -o "$ZIP" -d "$ROOT"

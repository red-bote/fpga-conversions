#!/bin/bash
# Drive Vivado to synthesise and build the Burnin' Rubber Basys3 bitstream.
#
...
#   vhdl_burnin_rubber_rev_0_0_2017_12_22/basys3/burnin_rubber_basys3.runs/impl_1/burnin_rubber_basys3.bit
#
...
XPR="$ROOT/vhdl_burnin_rubber_rev_0_0_2017_12_22/basys3/burnin_rubber_basys3.xpr"
...
WORK=/tmp/burnin_rubber_bitstream
mkdir -p "$WORK"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_burnin_rubber_rev_0_0_2017_12_22/basys3/burnin_rubber_basys3.runs/impl_1/burnin_rubber_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else

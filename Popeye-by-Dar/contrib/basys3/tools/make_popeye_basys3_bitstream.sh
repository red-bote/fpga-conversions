#!/bin/bash
# Drive Vivado to synthesise and build the Popeye Basys3 bitstream.
#
...
#   vhdl_popeye_rev_0_3_2020_01_27/basys3/popeye_basys3.runs/impl_1/popeye_basys3.bit
#
...
XPR="$ROOT/vhdl_popeye_rev_0_3_2020_01_27/basys3/popeye_basys3.xpr"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_popeye_rev_0_3_2020_01_27/basys3/popeye_basys3.runs/impl_1/popeye_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else

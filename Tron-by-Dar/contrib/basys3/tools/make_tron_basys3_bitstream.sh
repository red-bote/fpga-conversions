#!/bin/bash
# Drive Vivado to synthesise and build the Tron Basys3 bitstream.
#
...
#   vhdl_tron_rev_0_3_2019_11_22/basys3/tron_basys3.runs/impl_1/tron_basys3.bit
#
...
XPR="$ROOT/vhdl_tron_rev_0_3_2019_11_22/basys3/tron_basys3.xpr"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_tron_rev_0_3_2019_11_22/basys3/tron_basys3.runs/impl_1/tron_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else

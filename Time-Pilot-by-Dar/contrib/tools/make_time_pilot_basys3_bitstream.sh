#!/bin/bash
# Drive Vivado to synthesise and build the Time Pilot Basys3 bitstream.
#
...
#   vhdl_time_pilot_rev_0_0_2017_11_05/basys3/time_pilot_basys3.runs/impl_1/time_pilot_basys3.bit
#
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_time_pilot_rev_0_0_2017_11_05/basys3/time_pilot_basys3.runs/impl_1/time_pilot_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else

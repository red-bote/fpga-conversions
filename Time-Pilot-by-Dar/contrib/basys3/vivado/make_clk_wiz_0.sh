#!/bin/bash
# Generate the clk_wiz_0 MMCM IP (100 MHz -> 12.288 MHz core, 14.318 MHz sound) for the
# Basys3 port and place its Verilog wrappers where time_pilot_basys3.xpr expects them.
#
# The main project's .xpr references two imported files (time_pilot_basys3.xpr):
...
XPR_DIR="$(cd "$(dirname "$0")/../../../vhdl_time_pilot_rev_0_0_2017_11_05/basys3" && pwd)"
CLK_WIZ_IMPORT_DIR="$XPR_DIR/time_pilot_basys3.srcs/sources_1/imports/clk_wiz_0"

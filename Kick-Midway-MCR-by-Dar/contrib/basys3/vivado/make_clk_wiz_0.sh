...
# the Basys3 port and place its Verilog wrappers where kick_basys3.xpr
# expects them.
#
# The main project's .xpr references two imported files (kick_basys3.xpr):
...
XPR_DIR="$(cd "$(dirname "$0")/../../../vhdl_kick_rev_0_2_2019_11_22/basys3" && pwd)"
CLK_WIZ_IMPORT_DIR="$XPR_DIR/kick_basys3.srcs/sources_1/imports/clk_wiz_0"

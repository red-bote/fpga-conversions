#!/bin/bash
# Drive Vivado to synthesise and build the Kick Basys3 bitstream.
#
...
#   vhdl_kick_rev_0_2_2019_11_22/basys3/kick_basys3.runs/impl_1/kick_basys3.bit
#
...
XPR="$ROOT/vhdl_kick_rev_0_2_2019_11_22/basys3/kick_basys3.xpr"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_kick_rev_0_2_2019_11_22/basys3/kick_basys3.runs/impl_1/kick_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else

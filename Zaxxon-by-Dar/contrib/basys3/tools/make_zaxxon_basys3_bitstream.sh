#!/bin/bash
# Drive Vivado to synthesise and build the Zaxxon Basys3 bitstream.
#
...
#   vhdl_zaxxon_rev_0_0_2019_11_29/basys3/zaxxon_basys3.runs/impl_1/zaxxon_basys3.bit
#
...
XPR="$ROOT/vhdl_zaxxon_rev_0_0_2019_11_29/basys3/zaxxon_basys3.xpr"
...
if [ "$MODE" = "synth" ]; then
    ...
    BIT="$ROOT/vhdl_zaxxon_rev_0_0_2019_11_29/basys3/zaxxon_basys3.runs/impl_1/zaxxon_basys3.bit"
    if [ -f "$BIT" ]; then
        echo "Bitstream: $BIT"
    else
